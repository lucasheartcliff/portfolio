...
export default function ArticleCard({ article }: Props) {
  ...
  return (
    <motion.div
      ...
      className="glass-card relative flex w-full min-w-0 flex-col overflow-hidden p-4 text-base transition-all duration-200 dark:text-white md:w-72 md:text-xl"
    >
      <div
