...
describe('ProjectGrid', () => {
  ...
  it('should render initial items count', () => {
    render(
      <ProjectGrid items={items} initialItemsCount={3} itemsToAdd={3} />
    );
  ...
  it('should not show "Show more" button when all items are visible', () => {
    render(
      <ProjectGrid items={items} initialItemsCount={10} itemsToAdd={5} />
    );
    expect(
      screen.queryByText('Show more projects...')
